...
import activities.TabInterests;
import activities.TabCode;
...
public class TabProfileController extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_profile, menu);
        return true;
    }
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    ...
                    return tabProfile;
                case 1:
                    TabInterests tabInterests = new TabInterests();
                    return tabInterests;
                case 2:
                    TabHobbies tabHobbies = new TabHobbies();
                    return tabHobbies;
                case 3:
