...
public class GalleryCardAdapter extends RecyclerView.Adapter<GalleryCardAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Community> mComunity;
    private Context context;
    private FirebaseFunctions functions;

    public GalleryCardAdapter(Context mContext, List<Community> Comunity, Context context) {
    ...
    @NonNull
    @Override
    public GalleryCardAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.home_person_item, parent, false);
        return new GalleryCardAdapter.ImageViewHolder(v);
    }
